...
//    $x = $this->GetX();
//    $y = $this->GetY();
//      $serverName = "192.168.118.201";
//      $connectionInfo = array( "Database"=>"RMD5SCALE1", "UID"=>"sa", "PWD"=>"sipco77" , 'ReturnDatesAsStrings'=>true ,"CharacterSet" => "UTF-8");
