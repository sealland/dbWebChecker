...
//    $x = $this->GetX();
//    $y = $this->GetY();
//      $serverName = "192.168.118.105";
//      $connectionInfo = array( "Database"=>"RMD4SCALE1", "UID"=>"sa", "PWD"=>"sipco77" , 'ReturnDatesAsStrings'=>true ,"CharacterSet" => "UTF-8");
...
if (@file_exists(dirname(__FILE__).'/lang/eng.php')) {
 ...
 function fetch_data()
  {
     ...
     $serverName = "192.168.118.105";
      ...
      if( $conc === false ) {die( print_r( sqlsrv_errors(), true));}
            ...
            FROM dbo.vw_A2_rpt where  LEFT(CONVERT(varchar, [rmd_date],23),7) = '$ref2' order by rmd_date ";
     ...
     $output .='
         ...
         <td align="left"   width ="16%">&nbsp;'.$row4['rmd_size'].'&nbsp;</td>
         <td align="Right"  width ="8%">'.number_format($row4['length'],1).'&nbsp;</td>
         <td align="Center"   width ="8%">'.$row4['rmd_qa_grade'].'</td>
         <td align="Right"  width ="10%">'.number_format($row4['rmd_qty3']).'&nbsp;</td>
         <td align="right" width ="10%" >'.number_format($row4['rmd_weight']).'&nbsp;</td>
 ...
 function fetch_sum($ref)
   {
    ...
    $output='';
      ...
      <tr>
         <td align="right"   width ="62%" >รวม&nbsp;</td>
         <td class = "x" align="Right"  width ="10%">&nbsp;'.number_format($rows5['sQty3']).'&nbsp;</td>
         <td align="Right"   width ="10%">'.number_format($rows5['sweight']).'&nbsp;</td>
 ...
 //     <tr>
 //        <td align="Left"   width ="16%" >&nbsp;'.$row5['rmd_size'].'</td>
 //        <td align="left"   width ="8%">&nbsp;'.$row5['rmd_qa_grade'].'&nbsp;</td>
 //        <td align="left"   width ="18%">&nbsp;'.$row5['rmd_remark'].'&nbsp;</td>
 ...
 function fetch_summary($size,$ref2)
   {
    ...
    if( $conn === false ) {die( print_r( sqlsrv_errors(), true));}
      ...
      <tr>
         <td align="right"   width ="42%" ><b>รวม&nbsp;</b></td>
...
<th align="Center" width ="16%" rowspan ><b>ชนิดผลิตภัณฑ์</b></th>
...
<th align="Center" width ="10%" rowspan ><b>น้ำหนัก(Kg.)</b></th>
...
<th align="Center" width ="16%" rowspan><b>ชนิดผลิตภัณฑ์</b></th>
<th align="Center" width ="8%" rowspan ><b>เกรด</b></th>
<th align="Center" width ="18%" rowspan ><b>ปัญหา</b></th>
...
//$y = $pdf->GetY();
//$pdf->SetFont('cordiaupc', '', 14);
//$pdf->SetAbsXY(50,$y-6); //รวมมูลค่าสินค้าทั้งหมด
//$tamount = fetch_summary($ref);
//$pdf->writeHTML($tamount, true, false, false, false, '');
